 ...
 * guarantees with the player; a declined option ends the deal when the option year opens; a retirement owes
 * nothing more (spec 10.7); a replaced deal (a practice squad deal on promotion) just stops.
 */
export type ContractEndReason = 'released' | 'claimed' | 'traded' | 'declined' | 'retired' | 'replaced';
