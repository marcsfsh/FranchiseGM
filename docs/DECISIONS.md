...
- Revisit if: M13's coaches bring conflicts, or M15's trades move popular players.
...
## D-60: A contract market that spends to the cap
- When: 2026-09-26, M12
- Decision: Seven changes bring chained leagues' spending to the NFL's. The market curve puts half the top of a position's market at overall 80 (quarterbacks 77), with width 4.5 (was 83, 80, and 4). A player's demand runs 1.1 to 1.3 of his market value by greed (was 0.9 to 1.1), since a typical offer's role, loyalty, guarantees, and years add about a fifth of it, so the money a deal settles for centers on his market value. The AI's value of a deal prices each season at the cap expected then (mean revenue growth), and never below the market's price for his overall now at his age that season, so it's never gloomier about a veteran than the market it pays. The AI's offers are built as NFL deals are: the middle of the generator's signing bonus share for the yearly value's tier (38.5% from $20M, 25% from $5M, 6% below), its guaranteed years (2 from $20M, 1 from $8M), and void years to spread the bonus (2 from $20M, 1 from $8M, within 5 years of proration). A team with room past 4% of the cap pays up to its value times 1 plus 3 for each share of the cap past it, at most 1.6 times, and wants free agents up to 10 points under its weakest player at a group for each 1 of that premium past 1. As a league year opens, an AI team releases up to 4 veterans worth under 85% of the salary a release saves over their deals' years left, when the release saves room that year (cap casualties). Calibration judges the economy on chained seasons from each league's third, and cash from each league's second salary floor window, counted at the annual meeting after the re-sign window's bonuses. An 8-season probe: week 1 cap space 7.9% of the cap at the median team, 16.0% at the most; dead money 10.6%; cash 105.6% of the cap; the richest quarterback deal 19.3% and other deal 13.8%; free agents' richest 13.6%; 26.7 net-loss compensatory picks a draft.
- Why: Spec 23.3 checks cap space, dead money, contract values, and free agents against the market, and D-33's salary floor needs teams that spend like NFL teams. Under M12's first market, paying every veteran his market value filled only 68% of the caps (the generator scaled its deals up to fill them), the decision model settled deals at 80% to 88% of it, and the AI's value of a veteran fell faster than the market's price for him, so teams paid about 65% of the cap in cash, dead money stayed near 1%, and unused room compounded past 100% of a cap by the eighth season.
- Revisit if: M14's AI brain gives teams modes (a rebuilding team spends less), M15's trades add a market for players under contract, or M16's finances tie spending to owners' budgets.

## D-61: Spent deals leave sooner, and cap sheets read an index
- When: 2026-09-26, M12
- Decision: As a league year opens, a contract nobody holds, is due to take over, or has on waivers leaves once the last league year it charged the cap or paid cash has closed: a running deal's last year; a released or otherwise ended one's end year, the next when its dead money splits, or a later year of guaranteed salary still owed; a deal an extension replaced keeps its proration years. Tags stay two more league years, for the third-tag lookback. Each dropped deal's record still goes to the player's history (D-35). Cap sheets list a team's contracts from an index kept in memory beside the league's contracts, never saved: a loaded or copied league builds its own on first use, and the engine adds, replaces, and drops contracts only through the functions that keep it current.
- Why: A profile of chained seasons put over a quarter of their time in listing a team's contracts by scanning every one. Under D-31 released deals stayed until their original last year plus two and every spent deal two years past its end, so leagues held 8,000 to 9,000 contracts by their fifth season and each season ran about 10 s slower than the last; now they hold near 3,500, a season stays near 60 s, and the save grows about 0.9 MB a season instead of 1.5 MB (post-M23 2.18).
- Revisit if: M15's trades move contracts between teams (putContract already moves a contract's index entry), or M16's finances need cash from deals already dropped.

## D-62: What the 10-season run found at kickoff
- When: 2026-09-26, M12
- Decision: An elevation charges the cap what it cost the week he was elevated (the active minimum's week less his practice squad pay then), recorded with it, and a promotion in that week takes it back, since his new deal pays the week; a later change to his deal no longer reprices it. The AI's needs count a quarterback, kicker, punter, and long snapper as missing when the team carries none, and its surplus cut passes over a group whose players all joined this week. A team's next waiver claim at a group in a week is measured against the player its last claim displaced, so one team no longer claims five quarterbacks in a week. When a full roster can't dress for the game and has nobody to move to injured reserve, the staff releases the player the cutdown would let go next, and after dressing it fills back to the 53 minimum. In free agency a team with nobody at a position every game-day roster needs (a quarterback, kicker, punter, or long snapper) bids what one asks, one at a time, even over its value of him, since a specialist at the minimum asks more than a team values him.
- Why: D-46 binds the cap, the minimum, and a game-day roster at kickoff, and the 10-season run broke each once: a team over by an elevation repriced after a promotion, two teams left at 52 by injured reserve moves made to dress, and a team with no punter whose roster was full of quarterbacks claimed that week. After M12's market (D-65) a team whose long snapper left in free agency went into the season without one.
- Revisit if: M14's AI plans its roster ahead instead of fixing it at kickoff.

## D-63: The least a player takes stays hidden behind his agent and the front office's range
- When: 2026-09-26, M12 (the user's additions)
- Decision: Every player carries a hidden deal style, drawn once from its own stream when his league or draft class is made: how hard his agent bargains and how much he values money up front (0 to 100 each, means 50 and 45), and how front offices misread him (0 to 100, drawn evenly). His agent opens over the least he'd take now by 3% to 15% by how hard he bargains, in talks and through free agency's bidding weeks alike, and in talks comes down with each offer he turns down (D-54); through the bidding weeks the least he'd take now includes what he holds out for (D-65), so an offer at the agent's ask is always enough when no rival beats it. No screen shows the least he'd take: the user's front office gives a range of salaries a year on the offer's terms around its read of him, 30% of that read wide under a GM with no negotiation skill down to 8% under the best, with the real floor anywhere from a fifth to four fifths of the way up it by how front offices misread him. Neither the range's width nor its place gives the floor away, since both follow the hidden misread. Refusals no longer name a price, and the bidding dialog reads the offer against the range and says how many other teams are bidding without their terms. Offers below the ask stand or get a counter as before.
- Why: The user asked that the floor be discovered through counters, with only a front office estimate narrower with better staff; a fixed opening margin would have let anyone work the floor out from the ask, and a range sized from the floor itself, placed by the agent, let the spec review recover the floor within 1.5% from its width.
- Revisit if: M13's staff adds a capologist or other front office roles that should read the market, or M14's AI brain estimates prices the way the user's front office does.

## D-64: A player values a deal's structure, and every offer carries guarantees
- When: 2026-09-26, M12 (the user's additions)
- Decision: A player weighs an offer's money by its structure (spec 11.7). Each guaranteed dollar (the signing bonus and the salary of fully guaranteed years) is worth 10% more to him than one that isn't, up to 20% more by 32 (from 26), and up to 10% more again the more injury-prone he is (his injury rating from 85 down to 65, more while hurt). A signing bonus dollar is worth up to 15% more by his taste for money up front (his hidden deal style, D-63). A per-game roster bonus counts at the share of games he expects to dress: 92% as a starter, 80% in the rotation, and 55% as a backup, less when fragile. An offer can add one performance incentive a season, a stat his position produces at a mark, which he counts at the odds he gives himself of reaching it (a logistic curve of his pace over the mark, a quarter with no season to go by). As each league year opens, every deal's incentives with a stat mark count on the cap as likely to be earned when his last regular season reached the mark (the CBA's Article 13), and they settle when the regular season ends; season totals count the regular season only, as NFL records do. Each year a deal's length misses the one he wants costs 1.5% of his market value: 2 years while he's 26 or younger and 4 or more points under his potential, every year he can get once he's 30 or fragile, and 4 otherwise. Guarantees sit among the offer dialog's main terms, and a counter names guaranteed money, more of it up front as a bonus, a longer or shorter deal, or money each year as what matters most to him.
- Why: The user asked that guaranteed money be worth more than money that isn't (more for older and injury-prone players), that signing bonuses be valued by players who prefer cash up front, that length preferences depend on age and situation, that incentives count at their likelihood, and that every offer include guarantees; D-52 counted only a flat bonus and length premium.
- Revisit if: M13's staff adds agents or coach relationships to the decision, or M16's finances make cash timing matter to teams.

## D-65: Free agency is a market, and new deals are priced against the market when signed
- When: 2026-09-26, M12 (the user's additions)
- Decision: Through free agency's four bidding weeks each AI team opens its offer to a free agent at the least he'd take on its usual deal (D-60's bonus, guarantees, and void years by size, priced by his own model, D-64), plus up to 10% for the ones it wants most. A team's room no longer multiplies its opening offer (D-60); it raises the most the team will pay (its value of the deal times its room premium) and how deep it signs. A free agent who waits keeps his offers, and as each week opens every team he passed on raises its offer 5% a year while he's still worth that to it and its offers fit its room. As each week ends a free agent holds out for more than the least he'd take, 8% more at middling greed (4% to 12% by greed) in the first week, falling evenly to nothing by the fourth, while the least he'd take softens 5% a week (D-52): the best free agents sign first at the highest prices and the rest for less. The user's offer dialog reads an offer against the front office's range and says how many other teams are bidding, never their terms, and the week's inbox names each player still weighing the user's offer, how many other offers he has, and what his agent wants a year on the user's terms. His agent's ask, the front office's range, and a GM's settled deal all count what he holds out for, so an offer at the ask signs when no rival beats it (D-63). With the overpaying gone, a player's demand runs 1.2 to 1.4 of his market value by greed (was 1.1 to 1.3), since a typical deal's structure (D-64), role, and loyalty add about a quarter of it; the market curve puts half the top of a position's market at overall 79.75 (quarterbacks 76.75; were 80 and 77), so paying players about their market value fills the caps; and a quarterback's top is the record against the cap it was signed under, Dak Prescott's $60M against the 2024 cap, 23.5% (was 20%, the same deal against the 2026 cap), since deals price when signed. Calibration prices each new deal against the market when he signed, read before camp's development, and counts re-signings and extensions, which it had missed; free agents' first-week prices over their later ones get a band from spec 11.8's softening market. An 8-season probe: free agents who changed teams signed at 1.17 times their market value (was 1.54), 1.26 in the first week falling to 1.07 in the fourth, and re-signings at 1.01; median week 1 cap space 6.0% of the cap and the most 17.5%, dead money 10.3%, cash 104.4% of the cap, the richest quarterback deal 21.0% and other deal 12.4%, and free agents' richest 16.9%.
- Why: The user asked that AI teams make competing offers, players wait for better ones, prices run highest in the first days and fall as the market settles, and the user see when a player is weighing other offers without their terms. With D-60's room premium on every opening offer, free agents who changed teams signed at 1.54 times their market value, against spec 23.3's check of contract values against the market.
- Revisit if: M14's AI brain plans cap space by team mode or extends stars before a deal's last year, or M15's trades make a market for players under contract.

## D-66: Re-signings and extensions settle through the same negotiation as free agents
- When: 2026-09-26, M12 (the user's additions)
- Decision: D-29's stand-in, an extension at the player's asking price with no bonus, is gone. Every deal a GM settles is built as the AI builds its offers (D-60's bonus, guarantees, and void years by size) at the least yearly value whose worth to the player, by the same decision model as every offer (D-52, D-64), reaches what the GM settles for: the least he'd take plus the part of his agent's opening (D-63) the GM's negotiation skill doesn't win back. The AI's re-signings in the window, its extensions, and its answers to holdouts and trade requests settle this way, and so does the user's "Have your GM negotiate" choice for extensions and free agents alike, whose preview names every term the user agrees to: the yearly value and length, the signing bonus, the guaranteed years, and any void years. The user negotiates a re-signing or extension exactly as a free agent's deal: his agent's ask, counters naming what matters most, the front office's range, and take-it-or-leave-it offers. Fifth-year options, tags, and tenders still compare their prices with the salary a GM would settle for.
- Why: The user asked that re-signings and extensions use the same negotiation as free agency, replacing D-29's asking-price stand-in.
- Revisit if: M14's AI brain gives teams cap strategies (front-loaded extensions, restructures) or estimates prices the way the user's front office does.
