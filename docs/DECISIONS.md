...
- When: 2026-09-26, M12
- Decision: As a league year opens, the league keeps the unrestricted free agents whose deals ran out and the teams they left. At the annual meeting a year later, each who signed with another team from free agency's first week through the draft, is still on that team, and whose new deal's yearly value ranks in the top 35% of the league's veteran deals (rookie, undrafted, and practice squad deals left out) qualifies, worth round 3 in the top 3%, 4 in the top 8%, 5 in the top 15%, 6 in the top 25%, and 7 in the top 35%, a round better with 75% of his new team's snaps last season (to round 3 at best) and a round worse under 25% (out past round 7). A team's qualifying signings cancel its losses, each the best loss of the same round, else the best loss of a later round, else the worst loss left; a team that lost more than it signed gets a pick for each loss left, its best 4, and the league awards its best 32, each numbered after its round's regular picks, the best first. The limits (32 a draft, rounds 3 to 7, 4 a team) are rule set values. Postseason honors join the value with M17's awards. The user hears of his picks in the inbox, the news covers the award and any round 3 pick. A probe's first award gave 24 picks.
- Why: Spec 11.8 awards up to 32 picks in rounds 3 to 7, at most 4 a team, to teams that lost more (or better) qualifying unrestricted free agents than they signed, valued by contract, playing time, and honors, announced at the annual meeting; the NFL cancels losses with signings of the same value first.
