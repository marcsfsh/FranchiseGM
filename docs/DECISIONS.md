...
- Revisit if: M14's AI brain plans cap space by team mode or extends stars before a deal's last year (the richest quarterback deal runs under the NFL's 19% to 26% of the cap, since new deals price at the market's top and age against a growing cap), or M15's trades make a market for players under contract.
