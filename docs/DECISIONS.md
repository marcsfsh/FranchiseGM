...
- Decision: Every player carries a hidden deal style, drawn once from its own stream when his league or draft class is made: how hard his agent bargains and how much he values money up front (0 to 100 each, means 50 and 45). His agent opens over the least he'd take (his demand, D-52) by 3% to 15% by how hard he bargains, in talks and through free agency's bidding weeks alike, and in talks comes down with each offer he turns down (D-54). No screen shows the least he'd take: the user's front office gives a range of salaries a year on the offer's terms, 30% of it wide under a GM with no negotiation skill down to 8% under the best, with the real floor a fifth of the way up it for the hardest-bargaining agent and four fifths for the softest; refusals no longer name a price, and the bidding dialog reads the offer against the range and says how many other teams are bidding without their terms. Offers below the ask stand or get a counter as before.
- Why: The user asked that the floor be discovered through counters, with only a front office estimate narrower with better staff; a fixed opening margin would have let anyone work the floor out from the ask.
