...
- Current slice: review follow-ups before M10 (real-loop calibration, milestone SHAs, CI rule, depth chart layout)
- Next slice: M10 slice 1, sortable tables (post-M23 section 1.2)
